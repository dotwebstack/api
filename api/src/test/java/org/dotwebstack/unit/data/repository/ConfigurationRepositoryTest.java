...
public class ConfigurationRepositoryTest {
  ...
  public void testInitialize() throws IOException {
    //arrange
    ConfigurationRepository repository = new ConfigurationRepository(resourceLoader,
  ...
  public void testLoadTtlFile() throws IOException {
    ...
    when(resource.getInputStream())
        .thenReturn(new ByteArrayInputStream(pabloTtl.getBytes(StandardCharsets.UTF_8)));
    ConfigurationRepository repository = new ConfigurationRepository(resourceLoader, "", "test",
        "pablo.ttl");
    ...
    //assert
    assertEquals("There should have been 3 statements added to the in memory database", 3,
        result.size());
