...
public class ConfigurationRepository extends Rdf4JRepository {
  ...
  private void initialiseData(ResourceLoader resourceLoader, String defaultNamespace,
    ...
    for (String fileName : files) {
      ...
      Model model = Rio
          .parse(resource.getInputStream(), defaultNamespace, fileFormats.get(extension));
      result.addAll(model);
    }
