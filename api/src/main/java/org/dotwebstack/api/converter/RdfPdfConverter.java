...
public class RdfPdfConverter extends WriteOnlyRdfConverter {
    ...
    protected void writeInternal(Model statements, HttpOutputMessage httpOutputMessage) throws IOException, HttpMessageNotWritableException {
        ...
        try (PDDocument document = new PDDocument()) {
            ...
            try (PDPageContentStream contentStream = new PDPageContentStream(document, page)) {
                ...
                BaseTable table = new BaseTable(page.getMediaBox().getHeight() - 50, yStartNewPage, bottomMargin, tableWidth, margin, document, page, true, drawContent);
    ...
    private void createTitle(PDPage page, PDPageContentStream contentStream) {
        ...
        PDStreamUtils.write(contentStream, "Linked data results", font, titleFontSize, leftMargin, yPosition, Color.BLACK);
    }
}
