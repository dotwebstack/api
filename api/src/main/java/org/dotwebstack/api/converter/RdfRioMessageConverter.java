...
public class RdfRioMessageConverter extends AbstractHttpMessageConverter<Model> {
  ...
  /**
   * The converter for content negotiation. All {@link Model} objects will be converted with the Rio
   * parser <p> Make sure you define a namespace on your headers for formats with relative paths,
   * like JSON-ID
   *
